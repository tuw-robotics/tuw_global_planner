...
void VoronoiSerializer::loadMap(std::string mapInfoName, std::string mapPath)
{
  ...
  map_.setGeometry(grid_map::Length(mapInfo_.cols * mapInfo_.resolution, mapInfo_.rows * mapInfo_.resolution),
                   mapInfo_.resolution, grid_map::Position(mapInfo_.origin_cols, mapInfo_.origin_rows));
