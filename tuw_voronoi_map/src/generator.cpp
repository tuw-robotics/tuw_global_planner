...
void VoronoiGenerator::computeDistanceField(grid_map::GridMap& _gridMap, const std::string& _layerSrc,
                                            const std::string& _layerDes)
{
  static Mat srcMap;
...
void VoronoiGenerator::computeVoronoiMap(grid_map::GridMap& _gridMap, const std::string& _layerSrc,
                                         const std::string& _layerDes)
{
  static Mat srcMap;
