...
public:
  ...
  /**
   * @brief computes the voronoi map using Greyscale thinning (not exactly but basically (A.Nedzved, S. Uchida, S.
   * Ablameyko)) and thinning (Zang, Suen) thinning to skeletonize the found voronoi graph
   * @param _gridMap the grid map containing the src and dst _layerDes
