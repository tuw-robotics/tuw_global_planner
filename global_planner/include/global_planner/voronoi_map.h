...
private:
  ...
  * @param start              The start point (of the graph) (only important for the heuristic and the potential
  *calculation)
  * @param current            The previos point from which we expandDijkstraToEnd
  * @param next               The point we want to expand to
  * @param end                The final end point (of the graph) (only important for the heuristic and the potential
  *calculation)
  ...
  **/
  void addExpansionCandidate(Index start, Index current, Index next, Index end, int8_t *map, int8_t *voronoi_map,
                             float *dist_field, float *potential, bool expand_on_voronoi,
                             bool expand_dijkstra_to_voronoi);
  ...
  **/
  Index expandDijkstraToVoronoi(Index start, Index end, int cycles, int8_t *map, int8_t *voronoi_map, float *dist_field,
                                float *potential);
  ...
  * @return               the index of the voronoi Node (-1 for nothing found),
  **/
  Index expandToEnd(Index start, Index end, int cycles, int8_t *map, int8_t *voronoi_map, float *dist_field,
                    float *potential);
  ...
  * @return               the index of the voronoi Node (-1 for nothing found),
  **/
  Index expandVoronoi(Index start, Index end, int cycles, int8_t *map, int8_t *voronoi_map, float *dist_field,
                      float *potential);
  ...
  **/
  std::list<Index> findVoronoiCandidates(Index start, int8_t *map, int8_t *voronoi_map, float *dist_field,
  ...
  **/
  ...
  /**
   * @brief           draws a line on the potential map with increasing (or decreasing) potential (if endPotential is
   *smaller 0 the stepCosts are 1 else it is (endPot-startPot)/steps
