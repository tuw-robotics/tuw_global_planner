...
{
float HeuristicsDiagonal::CalcHeuristic(double act_x, double act_y, double start_x, double start_y, double end_x,
...
float HeuristicsDiagonal::CalcCosts(double act_x, double act_y, double start_x, double start_y, double end_x,
